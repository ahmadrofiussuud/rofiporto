...
const Ribbons = ({
    ...
    `;
        ...
        // Listen on window so ribbon follows cursor even when behind page content
        ...
        // Use window-level events so we track mouse anywhere on the page
        ...
        return () => {
            ...
            const el = containerRef.current;
            if (el && gl.canvas && gl.canvas.parentNode === el) {
